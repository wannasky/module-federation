...
__webpack_require__.d(__webpack_exports__, {
  "UserContext": () => /* reexport */ UserContext
});
...
// CONCATENATED MODULE: ./apps/tembin/src/shared/user.context.tsx
var UserContext=index_js_eager_default().createContext("User Context");
// CONCATENATED MODULE: ./apps/tembin/src/shared/index.ts
...
module.exports = new Promise((resolve, reject) => {
	if(typeof hato !== "undefined") return resolve();
	__webpack_require__.l("/hato/hato-remote-entry.js", (event) => {
		if(typeof hato !== "undefined") return resolve();
...
var error = new Error();
module.exports = new Promise((resolve, reject) => {
	if(typeof nangka !== "undefined") return resolve();
	__webpack_require__.l("/nangka/nangka-remote-entry.js", (event) => {
		if(typeof nangka !== "undefined") return resolve();
		var errorType = event && (event.type === 'load' ? 'missing' : event.type);
		var realSrc = event && event.target && event.target.src;
		error.message = 'Loading script failed.\n(' + errorType + ': ' + realSrc + ')';
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "module-federation-tembin:";
...
/******/ 			var uniqueName = "module-federation-tembin";
...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					register("@shared/library", "0", () => () => __webpack_require__(758));
/******/ 					register("react", "16.13.1", () => () => __webpack_require__(294));
/******/ 					initExternal(823);
/******/ 					initExternal(301);
/******/ 				}
/******/ 				break;
...
/******/ 			179: () => loadFallback("default", "@shared/library", () => () => __webpack_require__(758)),
/******/ 			494: () => loadSingletonVersionCheckFallback("default", "react", [0,15], () => () => __webpack_require__(294)),
/******/ 			382: () => loadSingletonVersionCheckFallback("default", "react", [,[1,16,0,0],[1,15,0,0],[2,0,14,0],1,1], () => () => __webpack_require__(294)),
/******/ 			227: () => loadSingletonVersionCheckFallback("default", "react", [1,16,13,1], () => () => __webpack_require__(294))
/******/ 		};
/******/ 		var initialConsumes = [227];
...
/******/ 		};
/******/ 		
/******/ 		var jsonpArray = this["webpackJsonpModuleFederation"] = this["webpackJsonpModuleFederation"] || [];
...
(() => {
// @ts-ignore
__webpack_require__.e(/* import() */ 174).then(__webpack_require__.bind(__webpack_require__, 174));
})();
