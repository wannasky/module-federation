...
const UserContext = index_js_eager_default().createContext("User Context");
...
var moduleMap = {
	"./Routes": () => {
		return __webpack_require__.e(938).then(() => () => (__webpack_require__(938)));
	}
};
var get = (module) => {
	return (
...
module.exports = new Promise((resolve, reject) => {
	if(typeof tembin !== "undefined") return resolve();
	__webpack_require__.l("/tembin/tembin-remote-entry.js", (event) => {
		if(typeof tembin !== "undefined") return resolve();
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "module-federation-hato:";
...
/******/ 			var uniqueName = "module-federation-hato";
...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					register("@shared/library", "0", () => () => __webpack_require__(255));
...
/******/ 			618: () => loadFallback("default", "@shared/library", () => () => __webpack_require__(255)),
...
/******/ })()
;
//# sourceMappingURL=hato-remote-entry.js.map